package com.ats.patna_tray_management.constants;

import android.content.Context;
import android.net.ConnectivityManager;
import android.net.NetworkInfo;

import com.ats.patna_tray_management.interfaces.InterfaceApi;
...
public class Constants {
    ...
    public static final String MY_PREF = "PATNA_TRAY_PREF";
